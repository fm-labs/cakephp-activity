<?php
namespace Activity\Test\Fixture;
...
class ActivitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => 'system', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
